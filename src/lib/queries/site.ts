...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  email: 'info@mantraacupuncture.com',
...
export const DEFAULT_PRACTITIONER: Practitioner = {
  ...
  bio: 'Dr. Nikku Thomas holds advanced clinical qualifications in Naturopathy, Yogic Sciences, and Acupuncture. Committed to high standards of patient care, Dr. Thomas provides personalized assessments and evidence-guided acupuncture therapies in a serene, supportive environment.',
